...
class TestUnetTrainingFairMetadata:
    """Tests for forwarding FAIR metadata to make_model_description."""
    ...
    def test_unet_training_forwards_fair_metadata(
        self,
        mock_concat,
        mock_data_loader,
        mock_create_config,
        ...
        """Test that FAIR metadata kwargs reach make_model_description."""
